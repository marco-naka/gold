...
const it = {
  meta: {
    ...
    /** Congiunzione per l'elenco degli asset: "BTC, USDt o XAUT". */
    assetsConjunction: 'o',
  ...
  hero: {
    ...
    subtitle: (event) =>
      `Paga i tuoi acquisti in crypto nei negozi convenzionati con POS NAKA durante il ${event} e partecipa all’estrazione di premi in Tether Gold (XAUT).`,
  ...
  form: {
    ...
    txLabel: 'Numero transazione',
    txHint: 'Lo trovi sulla ricevuta del POS o nel tuo wallet.',
    txPlaceholder: 'es. 0x4f2a… · lnbc… · rif. ricevuta',
    ...
    errors: {
      ...
      tx_duplicate: 'Numero transazione già utilizzato per una giocata precedente.',
  ...
  b2b: {
    ...
    ctaVideo: 'Premio Best Social Video',
  ...
  video: {
    metaTitle: (prize) => `Best Social Video — ${prize} in palio | NAKA`,
    metaDescription:
      'Come partecipare al premio Best Social Video del concorso NAKA: hashtag, requisiti, criteri di selezione e idee per il tuo video.',
    back: 'Torna al montepremi',
    badge: 'Premio riservato ai merchant',
    titleLead: 'Best',
    titleGold: 'Social Video',
    intro: (event, city, week, prize) =>
      `Racconta in un video come si paga in crypto nel tuo negozio e promuovi l’iniziativa, che dura tutta la settimana del ${event} di ${city}: ${week}. Tra i video di maggior successo, quello che piace di più vince ${prize} in Tether Gold.`,
    ctaSubmit: 'Candida il tuo video',
    ...
    finalTitle: 'Hai girato il tuo video?',
    finalText:
      'Mandaci il link: senza la segnalazione via email il video non entra ufficialmente in gara, anche se hai usato tutti gli hashtag.',
    mailSubject: 'Best Social Video — candidatura',
    mailBody: [
