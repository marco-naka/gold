...
const it = {
  ...
  hero: {
    ...
    rowTotal: 'Montepremi',
    valueNote: (date) => `Controvalore al ${date}: può variare in qualsiasi momento con il prezzo dell’oro.`,
    valueLink: 'Vedi il cambio aggiornato',
  ...
  how: {
    ...
    networksTitle: 'Reti accettate per il concorso',
    networksNote: 'Un pagamento su una rete diversa non rientra nel concorso.',
    networkOn: 'su',
    ...
    items: [
      {
        ...
        a: 'Sui POS NAKA si paga in Bitcoin sulla rete Lightning, in USD₮ sulle reti Ethereum e Polygon e in Tether Gold sulla rete Ethereum. Un pagamento su un’altra rete non rientra nel concorso. Molti esercenti accettano anche LVGA, che però non dà diritto alla partecipazione al concorso. Ogni merchant può abilitare uno o più asset: la disponibilità è indicata sulla scheda del negozio nella mappa.',
      },
      {
    ...
    merchantPrizes: {
      ...
      items: {
        ...
        'Estrazione Riservata Merchant': {
          ...
          text: 'È il premio più facile da raggiungere: basta una transazione crypto incassata durante la settimana per entrare nell’estrazione. Ogni negozio ha un biglietto, uno solo: incassarne cento non aumenta le probabilità.',
