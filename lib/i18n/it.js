...
const it = {
  ...
  form: {
    ...
    txHelp: {
      ...
      text: 'Sulla ricevuta del POS è la riga indicata come numero o riferimento della transazione, di solito sotto l’importo. Se hai pagato dal wallet, è l’ID della transazione nella cronologia dei pagamenti.',
      receiptLabel: 'RICEVUTA POS',
    },
  ...
  winners: {
    ...
    steps: [
      ...
      },
      {
        ...
        text: 'Dichiariamo in anticipo quale blocco della blockchain Bitcoin farà da sorgente casuale. Il suo hash non lo conosce nessuno prima che il blocco venga minato, organizzatore compreso, e nessuno può sceglierlo.',
      },
      {
