...
const it = {
  meta: {
    ...
    /** Congiunzione per l'elenco degli asset: "Bitcoin (Lightning) o USDt". */
    assetsConjunction: 'o',
    title: (contest, event) => `${contest} | NAKA × ${event}`,
    description:
      'Paga in crypto nei merchant aderenti di Lugano e Paradiso e vinci Oro Digitale in Tether Gold (XAUT).',
  ...
  hero: {
    ...
    subtitle: (event) =>
      `Paga i tuoi acquisti in crypto nei negozi con POS NAKA di Lugano e Paradiso e partecipa all’estrazione di premi in Tether Gold (XAUT). Nella settimana del ${event}.`,
    ctaUpload: 'Carica Scontrino e TX ID',
    ctaMap: 'Trova Negozi Aderenti',
    area: 'Lugano e Paradiso',
    ...
    statMerchants: 'Merchant sul circuito NAKA',
  ...
  form: {
    ...
    trust: {
      ...
      text: (organizer) =>
        `${organizer} è il circuito di pagamento che alimenta i POS crypto dei negozi di Lugano e Paradiso. Il concorso è promosso e i premi sono erogati direttamente da ${organizer}: i tuoi dati non vengono ceduti a nessun altro.`,
      link: 'naka.com',
    },
  ...
  map: {
    ...
    title: 'Dove pagare in crypto',
    subtitle: (event) =>
      `Gli esercenti del circuito NAKA a Lugano e Paradiso, attivi durante la settimana del ${event}.`,
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Tutti i clienti maggiorenni che effettuano un acquisto in crypto su POS NAKA presso un merchant aderente di Lugano o Paradiso nel periodo di validità del concorso. Sono esclusi i dipendenti di NAKA e i loro familiari diretti.',
      },
      {
    ...
    articles: ({ contest, organizer, event, city, from, to, draw, support, users, merchants, prizeList }) => [
      {
        ...
        body: [
          ...
          'L’iniziativa ha lo scopo di promuovere l’utilizzo dei pagamenti in criptovaluta tramite terminali POS NAKA presso gli esercenti aderenti dei Comuni di Lugano e Paradiso.',
        ],
      },
      {
