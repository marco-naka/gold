...
const en = {
  meta: {
    ...
    description:
      'Pay with crypto at participating merchants in Lugano and Paradiso and win Digital Gold in Tether Gold (XAUT).',
  ...
  hero: {
    ...
    subtitle: (event) =>
      `Pay with crypto at shops running a NAKA POS in Lugano and Paradiso and enter the prize draw for Tether Gold (XAUT). During ${event} week.`,
    ctaUpload: 'Submit Receipt & TX ID',
    ctaMap: 'Find Participating Shops',
    area: 'Lugano and Paradiso',
    ...
    statMerchants: 'Merchants on the NAKA network',
  ...
  form: {
    ...
    trust: {
      ...
      text: (organizer) =>
        `${organizer} runs the payment network behind the crypto POS terminals in Lugano and Paradiso shops. The campaign is promoted and the prizes are paid directly by ${organizer}: your data is not passed on to anyone else.`,
      link: 'naka.com',
    },
  ...
  map: {
    ...
    title: 'Where to pay with crypto',
    subtitle: (event) => `Merchants on the NAKA network in Lugano and Paradiso, open during ${event} week.`,
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: 'Who can take part?',
        a: 'Any customer aged 18 or over who makes a crypto purchase on a NAKA POS at a participating merchant in Lugano or Paradiso during the campaign period. NAKA employees and their immediate family are excluded.',
      },
      {
    ...
    articles: ({ contest, organizer, event, city, from, to, draw, support, users, merchants, prizeList }) => [
      {
        ...
        body: [
          ...
          'Its purpose is to promote cryptocurrency payments through NAKA POS terminals at participating merchants in the municipalities of Lugano and Paradiso.',
        ],
      },
      {
