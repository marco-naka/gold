    ...
    items: [
      {
        ...
        a: 'NAKA POS terminals take Bitcoin over the Lightning Network (BTC), Tether (USD₮) and Tether Gold (XAUT); many also accept LVGA, which however does not qualify for this campaign. Each merchant can enable one or more assets: availability is shown on the shop card in the map.',
      },
      {
