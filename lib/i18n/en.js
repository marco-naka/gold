...
const en = {
  ...
  form: {
    ...
    txHelp: {
      ...
      text: 'On the POS receipt it is the line marked as transaction number or reference, usually below the amount. If you paid from your wallet, it is the transaction ID in your payment history.',
      receiptLabel: 'POS RECEIPT',
    },
  ...
  winners: {
    ...
    steps: [
      ...
      },
      {
        ...
        text: 'We state in advance which Bitcoin block will provide the randomness. Nobody knows its hash before the block is mined — us included — and nobody can choose it.',
      },
      {
