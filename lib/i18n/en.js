...
const en = {
  ...
  form: {
    ...
    txLabel: 'Transaction no.',
    txHint: 'On the NAKA receipt it is the line marked “N° TRANSAZIONE”: 32 letters and digits.',
    txPlaceholder: 'e.g. b72134bf088d4df88eaf55c3b90adca2',
    ...
    txHelp: {
      ...
      text: 'On the NAKA receipt look for “N° TRANSAZIONE”: it is printed across two lines, above the terminal and the shop name. Copy all of it, including the part that wraps.',
      receiptLabel: 'NAKA',
    },
