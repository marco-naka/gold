...
export const PAYMENT_ASSETS = [
  ...
  { code: 'USDT', label: 'USDt', short: 'USDt', networks: ['Ethereum', 'Polygon'] },
...
/** Prezzo corrente di XAUT, per chi vuole controllare il controvalore. */
export const XAUT_PRICE_URL = 'https://www.coingecko.com/en/coins/tether-gold';
