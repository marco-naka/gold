...
export const CONTEST = {
  ...
  validFrom: process.env.NEXT_PUBLIC_CONTEST_VALID_FROM || '2026-10-19T00:00:00+02:00',
  ...
  weekLabel: 'da lunedì 19 a sabato 24 ottobre 2026, fino alle 16:00',
};
...
const PRIZE_TIERS = {
  users: {
    note: 'Montepremi complessivo riservato ai clienti finali',
    items: [
  ...
  merchants: {
    note: 'Montepremi complessivo riservato ai merchant aderenti',
    items: [
      {
...
export const SOCIAL_CONTEST = {
  ...
  hashtags: ['#PagaInCryptoLugano', '#NAKA', '#LuganoPlanB'],
  mentions: [
    { platform: 'Instagram', handle: '@naka', url: 'https://www.instagram.com/', toConfirm: true },
...
export const NAV_LINKS = [
  ...
  { label: 'Montepremi', href: '#montepremi' },
  { label: 'Mappa Merchant', href: '#mappa' },
  { label: 'Carica Scontrino', href: '#partecipa' },
];
