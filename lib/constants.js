...
export const CONTEST = {
  ...
  /**
   * L'estrazione si tiene lo stesso giorno della chiusura, a poche ore dallo stop alle giocate:
   * il commit dell'elenco esce subito dopo la chiusura e il blocco Bitcoin che fa da seme
   * viene annunciato prima, così fra impegno e sorteggio restano comunque un paio d'ore.
   */
  drawDate: '2026-10-24T18:00:00+02:00',
  /**
   * Finestra per registrare una giocata dopo la chiusura: chi paga alle 15:58 deve fare in
   * tempo a fotografare lo scontrino. Tenuta corta perché l'estrazione è lo stesso giorno.
   */
  graceMinutes: 30,
  /**
 ...
 *
 * Nei dati della crypto map cittadina tutti e 336 i merchant accettano BTC e USDt e NESSUNO
 * accetta XAUT: il token resta l'asset del premio, non un metodo di pagamento.
 * Se NAKA conferma che i POS incassano anche in XAUT, basta rimettere qui la voce.
 */
